...
type ContentListProps = {
  ...
  liveDemo: Content.ContentIndexSlice["primary"]["live_demo"];
};
    ...
    <>
      ...
      >
        {items.map((post, index) => (
          ...
          >
            <div
              className="flex flex-col justify-between items-center border-t border-t-slate-100 py-10  text-slate-200 md:flex-row "
            ...
            >
              ...
              >
                <span className="ml-auto flex items-center gap-2 text-xl font-medium md:ml-0">
                  {viewMoreText} <RxOpenInNewWindow />
                </span>
              </a>
              {liveDemo && (
