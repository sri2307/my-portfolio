...
export interface AboutSliceDefaultPrimary {
  ...
  /**
   * Button Label field in *About → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
...
export interface ContentIndexSliceDefaultPrimary {
  ...
  /**
   * Live Demo field in *ContentIndex → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: content_index.primary.live_demo
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  live_demo: prismic.KeyTextField;
}
...
export interface SkillsSliceDefaultItem {
  ...
  /**
   * Skill Color field in *Skills → Items*
   *
   * - **Field Type**: Color
   * - **Placeholder**: *None*
   * - **API ID Path**: skills.items[].skill_color
...
export interface TextBlockSliceDefaultPrimary {
  /**
   * Details field in *TextBlock → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: text_block.primary.details
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
